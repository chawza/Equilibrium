...
| `ConfirmPopover.svelte` | Inline confirmation prompt (used in Tag Manager delete and Settings danger zone). Replaces the target button with "Are you sure? [Cancel] [Confirm]" — no AlertDialog. |
